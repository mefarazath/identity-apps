...
<%
    ...
    String imagePath = theme.getLogo();
    String titleText = theme.getTitleText();
%>
...
<div class="product-title">
    ...
    <% } else {%>
    <div class="theme-icon inline auto transparent">
        <img src="<%=imagePath%>" height="60px" width="80px" />
    </div>
    <%}%>
    ...
    <% } else { %>
    <h1 class="product-title-text"><%=AuthenticationEndpointUtil.i18n(resourceBundle, titleText)%></h1>
    <% }%>
</div>
